LABS = [
    ...
    },
    {
        ...
        "description": "Escape web directories to read sensitive local files, bypassing WAF filters.",
    ...
    },
    {
        "id": "open_redirect",
        "name": "Open Redirects",
        "description": "Exploit unvalidated redirects to bypass URL filters and phish users.",
    ...
    },
    {
        ...
        "description": "Exploit insecure PRNGs, AES-ECB block manipulation, and MD5 collisions.",
        "category": "Cryptography",
        "difficulty": "Expert",
        "xp_available": 600,
        "challenges_count": 3
    ...
    {
        "id": "dom_attacks",
        "name": "DOM & Frontend Attacks",
        "description": "Exploit client-side code via DOM XSS, Open Redirects, and Prototype Pollution.",
    ...
    },
    {
        ...
        "description": "Exploit Time-of-Check to Time-of-Use flaws to duplicate items, bypass limits, and over-transfer.",
    ...
    "path_traversal": [
        {
            ...
            "description": "Read a system file by escaping the web directory.",
            "hint": "GET /api/labs/path/read?file=../../../../../windows/win.ini or /etc/passwd",
            "difficulty": "Intermediate",
            "xp": 150,
            "flag": "flag{path_basic_traversal}",
            "badge": "🏆 Explorer"
        },
        {
            "id": 2,
            "title": "Null Byte Bypass",
            "description": "Bypass a file extension check by injecting a null byte.",
            "hint": "GET /api/labs/path/read?file=../../../../../windows/win.ini%00.txt",
            "difficulty": "Advanced",
            "xp": 200,
            "flag": "flag{path_null_byte}",
            "badge": "🏆 Null Evader"
        },
        {
            "id": 3,
            "title": "Double URL Encoding",
            "description": "Bypass a WAF that strips path traversal sequences.",
            "hint": "GET /api/labs/path/read?file=%252e%252e%252f%252e%252e%252fwindows/win.ini",
            "difficulty": "Advanced",
            "xp": 200,
            "flag": "flag{path_double_encode}",
            "badge": "🏆 Encoder"
        }
    ],
    "open_redirect": [
        {
            "id": 1,
            "title": "Basic Open Redirect",
            "description": "Redirect a victim to an external attacker-controlled domain.",
            "hint": "GET /api/labs/redirect?url=http://attacker.com",
            "difficulty": "Beginner",
            "xp": 100,
            "flag": "flag{redirect_basic}",
            "badge": "🏆 Phisher"
        },
        {
            "id": 2,
            "title": "Protocol-Relative Bypass",
            "description": "Bypass a filter checking for 'http://' by using a protocol-relative URL.",
            "hint": "GET /api/labs/redirect?url=//attacker.com",
            "difficulty": "Intermediate",
            "xp": 150,
            "flag": "flag{redirect_protocol_relative}",
            "badge": "🏆 Slasher"
        },
        {
            "id": 3,
            "title": "Whitespace Bypass",
            "description": "Bypass URL prefix validation using whitespace.",
            "hint": "GET /api/labs/redirect?url= http://attacker.com",
            "difficulty": "Intermediate",
            "xp": 150,
            "flag": "flag{redirect_whitespace}",
            "badge": "🏆 Spacer"
        }
    ],
    "crypto_adv": [
        {
            "id": 1,
            "title": "Insecure Randomness (PRNG)",
            "description": "Exploit predictable tokens generated by an insecure PRNG.",
            "hint": "GET /api/labs/crypto/prng to get the 'random' token.",
            "difficulty": "Advanced",
            "xp": 200,
            "flag": "flag{crypto_prng_predict}",
            "badge": "🏆 Fortune Teller"
        },
        {
            "id": 2,
            "title": "AES-ECB Block Manipulation",
            "description": "Manipulate an ECB ciphertext to elevate privileges without the key.",
            "hint": "POST /api/labs/crypto/ecb with {\"ciphertext\": \"admin_block_hex\"}",
            "difficulty": "Expert",
            "xp": 300,
            "flag": "flag{crypto_ecb_penguin}",
            "badge": "🏆 Block Master"
        },
        {
            "id": 3,
            "title": "MD5 Hash Collision",
            "description": "Submit a payload that produces the same MD5 hash to bypass integrity checks.",
            "hint": "POST /api/labs/crypto/md5 with {\"data\": \"collision_payload\"}",
            "difficulty": "Advanced",
            "xp": 200,
            "flag": "flag{crypto_md5_collision}",
            "badge": "🏆 Collide"
    ...
    "dom_attacks": [
        {
            "id": 1,
            "title": "DOM-Based XSS",
            "description": "Exploit unsafe data flow entirely within the browser.",
            "hint": "GET /api/labs/dom/xss#<img src=x onerror=alert(1)>",
            "difficulty": "Intermediate",
            "xp": 150,
            "flag": "flag{dom_xss_hash}",
            "badge": "🏆 DOM Hacker"
        },
        {
            "id": 2,
            "title": "Client-Side Prototype Pollution",
            "description": "Pollute the Object prototype to manipulate client-side logic.",
            "hint": "GET /api/labs/dom/prototype?__proto__[isAdmin]=true",
            "difficulty": "Expert",
            "xp": 300,
            "flag": "flag{dom_proto_pollution}",
            "badge": "🏆 Proto Polluter"
        },
        {
            "id": 3,
            "title": "DOM Open Redirect",
            "description": "Manipulate window.location via client-side JavaScript.",
            "hint": "GET /api/labs/dom/redirect?next=javascript:alert(1)",
            "difficulty": "Intermediate",
            "xp": 150,
            "flag": "flag{dom_redirect_js}",
            "badge": "🏆 Client Router"
        }
    ],
    "race_condition": [
        {
            "id": 1,
            "title": "TOCTOU Discount Abuse",
            "description": "Apply a single-use discount multiple times concurrently.",
            "hint": "Send 5 concurrent POST requests to /api/labs/race/discount.",
            "difficulty": "Expert",
            "xp": 300,
            "flag": "flag{race_discount_abuse}",
            "badge": "🏆 Time Lord"
        },
        {
            "id": 2,
            "title": "Balance Transfer Race",
            "description": "Transfer more funds than you actually have.",
            "hint": "Send concurrent POST requests to /api/labs/race/transfer.",
            "difficulty": "Expert",
            "xp": 300,
            "flag": "flag{race_balance_overdraw}",
            "badge": "🏆 Infinite Money"
        },
        {
            "id": 3,
            "title": "Purchase Limit Overrun",
            "description": "Bypass an inventory or purchase limit.",
            "hint": "Send concurrent POST requests to /api/labs/race/limit.",
            "difficulty": "Advanced",
            "xp": 250,
            "flag": "flag{race_limit_bypass}",
            "badge": "🏆 Hoarder"
        }
    ]
}
